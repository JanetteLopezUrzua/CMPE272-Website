<!DOCTYPE html>
<?php
	$info = array("BLUE DIAMOND IN THE MIDDLE", "descriptions - rings/rings11.php", "rings/rings11.jpg", "3800", "1");
	$cookie_name = "rings11";
	...
	if (!isset($_COOKIE[$cookie_name]))
		setcookie($cookie_name, json_encode($info), time() + 60 * 60 * 24, '/');
	        ...
	        $info = array("BLUE DIAMOND IN THE MIDDLE", "descriptions - rings/rings11.php", "rings/rings11.jpg", "3800", $increment_visit);
	        setcookie($cookie_name, json_encode($info), time() + 60 * 60 * 24, '/');
        }
?>
<html lang="en-US">
<head>
  ...
  <title>Lour Jewelry - Blue Diamond in the Middle</title>
...
<div class="container"> 
  ...
  <section>
    ...
    <aside class="right_article"><img src="../images/rings/rings11.jpg" alt="" width="1537" height="2304" class="placeholder"/> </aside>
  </section>
  <!-- Footer Section -->
  <footer>
