<!DOCTYPE html>
<?php
	$info = array("DARK GREEN FLOWER RING", "descriptions - rings/rings9.php", "rings/rings9.jpg", "4199", "1");
	$cookie_name = "rings9";
	...
	if (!isset($_COOKIE[$cookie_name]))
		setcookie($cookie_name, json_encode($info), time() + 60 * 60 * 24, '/');
	        ...
	        $info = array("DARK GREEN FLOWER RING", "descriptions - rings/rings9.php", "rings/rings9.jpg", "4199", $increment_visit);
	        setcookie($cookie_name, json_encode($info), time() + 60 * 60 * 24, '/');
        }
?>
<html lang="en-US">
<head>
  ...
  <title>Lour Jewelry - Dark Green Flower Ring</title>
...
<div class="container"> 
  ...
  <section>
    ...
    <aside class="right_article"><img src="../images/rings/rings9.jpg" alt="" width="889" height="1333" class="placeholder"/> </aside>
  </section>
  <!-- Footer Section -->
  <footer>
