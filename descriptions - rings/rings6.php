<!DOCTYPE html>
<?php
	$info = array("PEARL IN THE MIDDLE", "descriptions - rings/rings6.php", "rings/rings6.jpg", "1800", "1");
	$cookie_name = "rings6";
	...
	if (!isset($_COOKIE[$cookie_name]))
		setcookie($cookie_name, json_encode($info), time() + 60 * 60 * 24, '/');
	        ...
	        $info = array("PEARL IN THE MIDDLE", "descriptions - rings/rings6.php", "rings/rings6.jpg", "1800", $increment_visit);
	        setcookie($cookie_name, json_encode($info), time() + 60 * 60 * 24, '/');
        }
?>
<html lang="en-US">
<head>
  ...
  <title>Lour Jewelry - PEearl in the Middle</title>
...
<div class="container"> 
  ...
  <section>
    ...
    <aside class="right_article"><img src="../images/rings/rings6.jpg" alt="" width="3744" height="5616" class="placeholder"/> </aside>
  </section>
  <!-- Footer Section -->
  <footer>
