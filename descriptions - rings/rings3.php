<!DOCTYPE html>
<?php
	$info = array("SQUARED ESMERALD", "descriptions - rings/rings3.php", "rings/rings3.jpg", "600", "1");
	$cookie_name = "rings3";
	...
	if (!isset($_COOKIE[$cookie_name]))
		setcookie($cookie_name, json_encode($info), time() + 60 * 60 * 24, '/');
	        ...
	        $info = array("SQUARED ESMERALD", "descriptions - rings/rings3.php", "rings/rings3.jpg", "600", $increment_visit);
	        setcookie($cookie_name, json_encode($info), time() + 60 * 60 * 24, '/');
        }
?>
<html lang="en-US">
<head>
  ...
  <title>Lour Jewelry - Squared Esmerald</title>
...
<div class="container"> 
  ...
  <section>
    ...
    <aside class="right_article"><img src="../images/rings/rings3.jpg" alt="" width="4912" height="7360" class="placeholder"/> </aside>
  </section>
  <!-- Footer Section -->
  <footer>
