<!DOCTYPE html>
<?php
	$info = array("MINI DIAMONDS", "descriptions - rings/rings5.php", "rings/rings5.jpg", "2499", "1");
	$cookie_name = "rings5";
	...
	if (!isset($_COOKIE[$cookie_name]))
		setcookie($cookie_name, json_encode($info), time() + 60 * 60 * 24, '/');
	        ...
	        $info = array("MINI DIAMONDS", "descriptions - rings/rings5.php", "rings/rings5.jpg", "2499", $increment_visit);
	        setcookie($cookie_name, json_encode($info), time() + 60 * 60 * 24, '/');
        }
?>
<html lang="en-US">
<head>
  ...
  <title>Lour Jewelry - Mini Diamonds</title>
...
<div class="container"> 
  ...
  <section>
    ...
    <aside class="right_article"><img src="../images/rings/rings5.jpg" alt="" width="2680" height="4016" class="placeholder"/> </aside>
  </section>
  <!-- Footer Section -->
  <footer>
