<!DOCTYPE html>
<?php
	$info = array("SKINNY GOLDEN", "descriptions - rings/rings8.php", "rings/rings8.jpg", "599", "1");
	$cookie_name = "rings8";
	...
	if (!isset($_COOKIE[$cookie_name]))
		setcookie($cookie_name, json_encode($info), time() + 60 * 60 * 24, '/');
	        ...
	        $info = array("SKINNY GOLDEN", "descriptions - rings/rings8.php", "rings/rings8.jpg", "599", $increment_visit);
	        setcookie($cookie_name, json_encode($info), time() + 60 * 60 * 24, '/');
        }
?>
<html lang="en-US">
<head>
  ...
  <title>Lour Jewelry - Skinny Golden</title>
...
<div class="container"> 
  ...
  <section>
    ...
    <aside class="right_article"><img src="../images/rings/rings8.jpg" alt="" width="3840" height="5760" class="placeholder"/> </aside>
  </section>
  <!-- Footer Section -->
  <footer>
