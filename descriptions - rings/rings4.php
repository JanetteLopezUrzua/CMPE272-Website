<!DOCTYPE html>
<?php
	$info = array("2 SMALL DIAMONDS", "descriptions - rings/rings4.php", "rings/rings4.jpg", "499", "1");
	$cookie_name = "rings4";
	...
	if (!isset($_COOKIE[$cookie_name]))
		setcookie($cookie_name, json_encode($info), time() + 60 * 60 * 24, '/');
	        ...
	        $info = array("2 SMALL DIAMONDS", "descriptions - rings/rings4.php", "rings/rings4.jpg", "499", $increment_visit);
	        setcookie($cookie_name, json_encode($info), time() + 60 * 60 * 24, '/');
        }
?>
<html lang="en-US">
<head>
  ...
  <title>Lour Jewelry - 2 Small Diamonds</title>
...
<div class="container"> 
  ...
  <section>
    ...
    <aside class="right_article"><img src="../images/rings/rings4.jpg" alt="" width="1729" height="2592" class="placeholder"/> </aside>
  </section>
  <!-- Footer Section -->
  <footer>
