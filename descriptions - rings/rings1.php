<!DOCTYPE html>
<?php
	$info = array("SILVER DIAMOND RING", "descriptions - rings/rings1.php", "rings/rings1.jpg", "1200", "1");
	$cookie_name = "rings1";
	...
	if (!isset($_COOKIE[$cookie_name]))
		setcookie($cookie_name, json_encode($info), time() + 60 * 60 * 24, '/');
	        ...
	        $info = array("SILVER DIAMOND RING", "descriptions - rings/rings1.php", "rings/rings1.jpg", "1200", $increment_visit);
	        setcookie($cookie_name, json_encode($info), time() + 60 * 60 * 24, '/');
        }
?>
<html lang="en-US">
<head>
  ...
  <title>Lour Jewelry - Silver Diamond Ring</title>
...
<div class="container"> 
  ...
  <section>
    ...
    <aside class="right_article"><img src="../images/rings/ring1.jpg" alt="" width="2003" height="3002" class="placeholder"/> </aside>
  </section>
  <!-- Footer Section -->
  <footer>
