<!DOCTYPE html>
<?php
	$info = array("SIMPLE SILVER PAIR", "descriptions - rings/rings7.php", "rings/rings7.jpg", "150", "1");
	$cookie_name = "rings7";
	...
	if (!isset($_COOKIE[$cookie_name]))
		setcookie($cookie_name, json_encode($info), time() + 60 * 60 * 24, '/');
	        ...
	        $info = array("SIMPLE SILVER PAIR", "descriptions - rings/rings7.php", "rings/rings7.jpg", "150", $increment_visit);
	        setcookie($cookie_name, json_encode($info), time() + 60 * 60 * 24, '/');
        }
?>
<html lang="en-US">
<head>
  ...
  <title>Lour Jewelry - Simple Silver Pair</title>
...
<div class="container"> 
  ...
  <section>
    ...
    <aside class="right_article"><img src="../images/rings/rings7.jpg" alt="" width="2832" height="4240" class="placeholder"/> </aside>
  </section>
  <!-- Footer Section -->
  <footer>
