<!DOCTYPE html>
<?php
	$info = array("PURPLE DIAMOND", "descriptions - rings/rings2.php", "rings/rings2.jpg", "3000", "1");
	$cookie_name = "rings2";
	...
	if (!isset($_COOKIE[$cookie_name]))
		setcookie($cookie_name, json_encode($info), time() + 60 * 60 * 24, '/');
	        ...
	        $info = array("PURPLE DIAMOND", "descriptions - rings/rings2.php", "rings/rings2.jpg", "3000", $increment_visit);
	        setcookie($cookie_name, json_encode($info), time() + 60 * 60 * 24, '/');
        }
?>
<html lang="en-US">
<head>
  ...
  <title>Lour Jewelry - Purple Diamond</title>
...
<div class="container"> 
  ...
  <section>
    ...
    <aside class="right_article"><img src="../images/rings/ring2.jpg" alt="" width="1233" height="1848" class="placeholder"/> </aside>
  </section>
  <!-- Footer Section -->
  <footer>
