<!DOCTYPE html>
<?php
	$info = array("BLUE COIN", "descriptions - necklaces/necklaces4.php", "necklaces/necklaces4.jpg", "199", "1");
	$cookie_name = "necklaces4";
	...
	if (!isset($_COOKIE[$cookie_name]))
		setcookie($cookie_name, json_encode($info), time() + 60 * 60 * 24, '/');
	        ...
	        $info = array("BLUE COIN", "descriptions - necklaces/necklaces4.php", "necklaces/necklaces4.jpg", "199", $increment_visit);
	        setcookie($cookie_name, json_encode($info), time() + 60 * 60 * 24, '/');
        }
?>
<html lang="en-US">
<head>
  ...
  <title>Lour Jewelry - Blue Coin</title>
...
<div class="container"> 
  ...
  <section>
    ...
    <aside class="right_article"><img src="../images/necklaces/necklaces4.jpg" alt="" width="3456" height="5184" class="placeholder"/> </aside>
  </section>
  <!-- Footer Section -->
  <footer>
