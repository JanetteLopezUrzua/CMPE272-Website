<!DOCTYPE html>
<?php
	$info = array("RED STONE", "descriptions - necklaces/necklaces6.php", "necklaces/necklaces6.jpg", "2000", "1");
	$cookie_name = "necklaces6";
	...
	if (!isset($_COOKIE[$cookie_name]))
		setcookie($cookie_name, json_encode($info), time() + 60 * 60 * 24, '/');
	        ...
	        $info = array("RED STONE", "descriptions - necklaces/necklaces6.php", "necklaces/necklaces6.jpg", "2000", $increment_visit);
	        setcookie($cookie_name, json_encode($info), time() + 60 * 60 * 24, '/');
        }
?>
<html lang="en-US">
<head>
  ...
  <title>Lour Jewelry - Red Stone</title>
...
<div class="container"> 
  ...
  <section>
    ...
    <aside class="right_article"><img src="../images/necklaces/necklaces6.jpg" alt="" width="2828" height="4242" class="placeholder"/> </aside>
  </section>
  <!-- Footer Section -->
  <footer>
