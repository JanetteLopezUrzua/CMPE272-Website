<!DOCTYPE html>
<?php
	$info = array("RAIN NECKLACE", "descriptions - necklaces/necklaces5.php", "necklaces/necklaces5.jpg", "800", "1");
	$cookie_name = "necklaces5";
	...
	if (!isset($_COOKIE[$cookie_name]))
		setcookie($cookie_name, json_encode($info), time() + 60 * 60 * 24, '/');
	        ...
	        $info = array("RAIN NECKLACE", "descriptions - necklaces/necklaces5.php", "necklaces/necklaces5.jpg", "800", $increment_visit);
	        setcookie($cookie_name, json_encode($info), time() + 60 * 60 * 24, '/');
        }
?>
<html lang="en-US">
<head>
  ...
  <title>Lour Jewelry - Rain Necklace</title>
...
<div class="container"> 
  ...
  <section>
    ...
    <aside class="right_article"><img src="../images/necklaces/necklaces5.jpg" alt="" width="2828" height="4242" class="placeholder"/> </aside>
  </section>
  <!-- Footer Section -->
  <footer>
