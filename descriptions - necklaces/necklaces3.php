<!DOCTYPE html>
<?php
	$info = array("BEIGE FLOWER", "descriptions - necklaces/necklaces3.php", "necklaces/necklaces3.jpg", "999", "1");
	$cookie_name = "necklaces3";
	...
	if (!isset($_COOKIE[$cookie_name]))
		setcookie($cookie_name, json_encode($info), time() + 60 * 60 * 24, '/');
	        ...
	        $info = array("BEIGE FLOWER", "descriptions - necklaces/necklaces3.php", "necklaces/necklaces3.jpg", "999", $increment_visit);
	        setcookie($cookie_name, json_encode($info), time() + 60 * 60 * 24, '/');
        }
?>
<html lang="en-US">
<head>
  ...
  <title>Lour Jewelry - Beige Flower</title>
...
<div class="container"> 
  ...
  <section>
    ...
    <aside class="right_article"><img src="../images/necklaces/necklaces3.jpg" alt="" width="2828" height="4242" class="placeholder"/> </aside>
  </section>
  <!-- Footer Section -->
  <footer>
