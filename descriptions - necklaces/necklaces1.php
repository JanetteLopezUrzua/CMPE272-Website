<!DOCTYPE html>
<?php
	$info = array("GOLDEN COIN", "descriptions - necklaces/necklaces1.php", "necklaces/necklaces1.jpg", "299", "1");
	$cookie_name = "necklaces1";
	...
	if (!isset($_COOKIE[$cookie_name]))
		setcookie($cookie_name, json_encode($info), time() + 60 * 60 * 24, '/');
	        ...
	        $info = array("GOLDEN COIN", "descriptions - necklaces/necklaces1.php", "necklaces/necklaces1.jpg", "299", $increment_visit);
	        setcookie($cookie_name, json_encode($info), time() + 60 * 60 * 24, '/');
        }
?>
<html lang="en-US">
<head>
  ...
  <title>Lour Jewelry - Golden Coin</title>
...
<div class="container"> 
  ...
  <section>
    ...
    <aside class="right_article"><img src="../images/necklaces/necklaces1.jpg" alt="" width="2669" height="4000" class="placeholder"/> </aside>
  </section>
  <!-- Footer Section -->
  <footer>
