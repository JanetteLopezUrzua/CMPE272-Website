<!DOCTYPE html>
<?php
	$info = array("STYLISH TRIO", "descriptions - bracelets/bracelets1.php", "bracelets/bracelets1.jpg", "50", "1");
	$cookie_name = "bracelets1";
	...
	if (!isset($_COOKIE[$cookie_name]))
		setcookie($cookie_name, json_encode($info), time() + 60 * 60 * 24, '/');
	        ...
	        $info = array("STYLISH TRIO", "descriptions - bracelets/bracelets1.php", "bracelets/bracelets1.jpg", "50", $increment_visit);
	        setcookie($cookie_name, json_encode($info), time() + 60 * 60 * 24, '/');
        }
?>
<html lang="en-US">
<head>
  ...
  <title>Lour Jewelry - Stylish Trio</title>
...
<div class="container"> 
  ...
  <section>
    ...
    <aside class="right_article"><img src="../images/bracelets/bracelets1.jpg" alt="" width="5472" height="3648" class="placeholder"/> </aside>
  </section>
  <!-- Footer Section -->
  <footer>
