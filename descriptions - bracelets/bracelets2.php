<!DOCTYPE html>
<?php
	$info = array("SILVER BRACELET", "descriptions - bracelets/bracelets2.php", "bracelets/bracelets2.jpg", "25", "1");
	$cookie_name = "bracelets2";
	...
	if (!isset($_COOKIE[$cookie_name]))
		setcookie($cookie_name, json_encode($info), time() + 60 * 60 * 24, '/');
	        ...
	        $info = array("SILVER BRACELET", "descriptions - bracelets/bracelets2.php", "bracelets/bracelets2.jpg", "25", $increment_visit);
	        setcookie($cookie_name, json_encode($info), time() + 60 * 60 * 24, '/');
        }
?>
<html lang="en-US">
<head>
  ...
  <title>Lour Jewelry - Silver Bracelet </title>
...
<div class="container"> 
  ...
  <section>
    ...
    <aside class="right_article"><img src="../images/bracelets/bracelets2.jpg" alt="" width="5184" height="3456" class="placeholder"/> </aside>
  </section>
  <!-- Footer Section -->
  <footer>
