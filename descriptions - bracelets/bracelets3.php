<!DOCTYPE html>
<?php
	$info = array("BLUE STONE", "descriptions - bracelets/bracelets3.php", "bracelets/bracelets3.jpg", "20", "1");
	$cookie_name = "bracelets3";
	...
	if (!isset($_COOKIE[$cookie_name]))
		setcookie($cookie_name, json_encode($info), time() + 60 * 60 * 24, '/');
	        ...
	        $info = array("BLUE STONE", "descriptions - bracelets/bracelets3.php", "bracelets/bracelets3.jpg", "20", $increment_visit);
	        setcookie($cookie_name, json_encode($info), time() + 60 * 60 * 24, '/');
        }
?>
<html lang="en-US">
<head>
  ...
  <title>Lour Jewelry - Blue Stone</title>
...
<div class="container"> 
  ...
  <section>
    ...
    <aside class="right_article"><img src="../images/bracelets/bracelets3.jpg" alt="" width="4096" height="2731" class="placeholder"/> </aside>
  </section>
  <!-- Footer Section -->
  <footer>
